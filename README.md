...
| --- | --- | --- |
| [modded-save-sync](mods/modded-save-sync/README.md) | v1.1.0 | Unifies vanilla and modded save paths so progress is never split between two locations |
| [reload-run](mods/reload-run/README.md) | v1.1.1 | Press F5 to reload the current room from its room-entry save state; F6 to start a multiplayer run solo |
