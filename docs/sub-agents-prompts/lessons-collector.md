...
You will receive a list of temporary file paths. Each file contains raw findings written by a coding or code-review sub-agent during a work session. Read every file before doing anything else.
...
Delete every temporary file you were given. Do not leave them behind.
